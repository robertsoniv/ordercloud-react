...
export function usePromoExpressions() {
  ...
  const buildProperties = (
    ...
    if (propertiesToInclude)
      Object.assign(filteredProperties, ...propertiesToInclude);
    return Object.entries(filteredProperties) as [
      string,
    ...
    (schemas: Record<string, OpenAPIV3.SchemaObject>): ExpressionModels[] => {
      ...
      return [
        ...
        },
        {
          label: "Order Return",
          path: "OrderReturn",
          properties: buildProperties(schemas.OrderReturn.properties, [
            "Comments",
          ]),
        },
        {
        ...
        },
        {
          label: "Cost Center",
          path: "CostCenter",
          properties: buildProperties(schemas.CostCenter.properties, [
            "Name",
            "Description",
          ]),
        },
              ...
              inputType:
                property.format === "date-time"
                  ...
                  : property.type === "number"
                    ...
                    : "text",
              valueEditorType:
                property.type === "boolean" ? "checkbox" : "text",
